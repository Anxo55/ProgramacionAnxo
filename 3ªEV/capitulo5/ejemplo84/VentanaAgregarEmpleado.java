...
public class VentanaAgregarEmpleado extends JFrame implements ActionListener {
	...
	private JLabel nombre, apellidos, cargo, salarioDia, númeroDias, genero, otrosIngresos, aportesSalud, pensiones;
	...
	public void inicio() {
		 ...
		 */
		númeroDias = new JLabel();
		númeroDias.setText("Días trabajados al mes:");
		/* Establece la posición de la etiqueta días trabajados al mes del empleado */
		númeroDias.setBounds(20, 200, 135, 23);
        //OJO ES UN SPINNER NUMERICO
